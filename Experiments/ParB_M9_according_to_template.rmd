...
ParB_M9 |> 
  ...
  mutate(
    ...
    difference_popping_time_last_replication = popping_time - start_of_last_replication) -> ParB_M9
```
...
ParB_M9 |>
  ...
  summarise(
    ...
    across(
      ...
      summarise_fcts,
      .names = "{.col}_{.fn}")) -> ParB_M9_over_all
...
ParB_M9 |>
  ...
  summarise(
    ...
    across(
      ...
      summarise_fcts,
      .names = "{.col}_{.fn}")) -> ParB_M9_over_condition


ParB_M9_over_condition |>
  pivot_longer(
    cols = -c(n, condition),
    names_to = c("variable", ".value"),
    names_pattern = "(\\w+)_(\\w+)")
...
ParB_M9 |>
  ...
  summarise(
    ...
    across(
      ...
      summarise_fcts,
      .names = "{.col}_{.fn}")) -> ParB_M9_over_replicate


ParB_M9_over_replicate |>
  pivot_longer(
    cols = -c(n, replicate),
    names_to = c("variable", ".value"),
    names_pattern = "(\\w+)_(\\w+)")
...
ParB_M9 |>
  ...
  summarise(
    ...
    across(
      ...
      summarise_fcts,
      .names = "{.col}_{.fn}")) -> ParB_M9_over_condition_and_replicate

ParB_M9_over_condition_and_replicate |>
  pivot_longer(
...
ParB_M9 |>
  ...
  summarise(
    ...
    across(
      ...
      summarise_fcts,
      .names = "{.col}_{.fn}")) -> ParB_M9_over_bins
...
ParB_M9 |>
  ...
  summarise(
    ...
    across(
      ...
      summarise_fcts,
      .names = "{.col}_{.fn}")) -> ParB_M9_over_max_foci_and_condition
...
ParB_M9 |>
  ...
  summarise(
    ...
    across(
      ...
      summarise_fcts,
      .names = "{.col}_{.fn}")) -> ParB_M9_over_max_foci_and_bins
...
ParB_M9_over_max_foci_and_condition |>
  ggplot(aes(
    x = condition,
    y = max_foci,
    size = n,
...
ParB_M9_over_max_foci_and_bins |>
  ggplot(aes(
    x = bin_prey_area,
    y = max_foci,
    size = n,
